...
//-- constants
	static const std::string DEFAULT_FILE_NAME = "configµ.ini"; ///< default name of the configuration file
...
//-- methods
	 ...
	 * @param the parameter value
	 */
	void SetSetting(std::string settingName, int value);
	 ...
	 * @param the parameter value
	 */
	void SetSetting(std::string settingName, bool value);
...
//-- private data members
	std::map<std::string, std::string> stringData; ///< map for the string parameters
	std::map<std::string, int> intData; ///< map for the integer parameters
	std::map<std::string, bool> boolData; ///< map for the boolean parameters
